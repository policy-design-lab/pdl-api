...
CRP_PRACTICE_CATEGORIES_DATA_JSON = "crp_practice_categories_data.json"
...
def programs_conservation_crp_practice_categories_search():
    # set the file path
    crp_data = os.path.join(CRP_JSON_DATA_PATH, CRP_PRACTICE_CATEGORIES_DATA_JSON)
